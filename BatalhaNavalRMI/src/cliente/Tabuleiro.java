...
//        navios.add(new cliente.Navio(1,2,5,0));
//        navios.add(new cliente.Navio(2,4,4,1));
//        navios.add(new cliente.Navio(7,0,4,1));
//        navios.add(new cliente.Navio(4,4,3,0));
//        navios.add(new cliente.Navio(5,6,3,1));
//        navios.add(new cliente.Navio(9,3,3,1));
//        navios.add(new cliente.Navio(0,0,2,0));
//        navios.add(new cliente.Navio(4,0,2,0));
//        navios.add(new cliente.Navio(0,9,2,0));
//        navios.add(new cliente.Navio(7,6,2,0));
