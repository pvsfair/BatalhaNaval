...
//        navios.add(new servidor.Navio(1,2,5,0));
//        pedacosDeNavioSemTiro += 5;
//        navios.add(new servidor.Navio(2,4,4,1));
//        pedacosDeNavioSemTiro += 4;
//        navios.add(new servidor.Navio(7,0,4,1));
//        pedacosDeNavioSemTiro += 4;
//        navios.add(new servidor.Navio(4,4,3,0));
//        pedacosDeNavioSemTiro += 3;
//        navios.add(new servidor.Navio(5,6,3,1));
//        pedacosDeNavioSemTiro += 3;
//        navios.add(new servidor.Navio(9,3,3,1));
//        pedacosDeNavioSemTiro += 3;
//        navios.add(new servidor.Navio(0,0,2,0));
//        pedacosDeNavioSemTiro += 2;
//        navios.add(new servidor.Navio(4,0,2,0));
//        pedacosDeNavioSemTiro += 2;
//        navios.add(new servidor.Navio(0,9,2,0));
//        pedacosDeNavioSemTiro += 2;
//        navios.add(new servidor.Navio(7,6,2,0));
//        pedacosDeNavioSemTiro += 2;
